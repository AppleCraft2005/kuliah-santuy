        ...
        <div id="inputContainer">
            <div class="input-group" >
                <div style="display: flex; gap: 20px;">
                    ...
                    <button class="btn-hapus" style="display: none;" onclick="hapusInput(this)">Hapus</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function tambahInput() {
            ...
            <div style="display: flex; gap: 20px;">
                ...
                <button type="button" class="btn-hapus" s onclick="hapusInput(this)">Hapus</button>
            </div>
            `;
            container.appendChild(group)
            updateStyleHapusButtons()
        }
        ...
        function updateStyleHapusButtons() {
            const inputGroups = document.querySelectorAll('.input-group');
            const hapusButtons = document.querySelectorAll('.btn-hapus');

            if (inputGroups.length > 1) {hapusButtons.forEach(btn => btn.style.display = 'inline-block');} 
            else {hapusButtons.forEach(btn => btn.style.display = 'none');}
        }
