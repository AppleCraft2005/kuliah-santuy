    ...
    <div class="container">
        ...
        <main>
            <div class="data-container">
                ...
                <a href="<?= base_url('user/peminjaman') ?>">Tambah</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(session()->get('username') === $p['nama_peminjam']): ?>
                                        <a href="<?= base_url('user/peminjaman/edit/'. $p['id_peminjaman']); ?>"><i class="fa-solid fa-pen-to-square"></i></i></a> | <a href="<?= base_url('user/peminjaman/delete/'. $p['id_peminjaman']); ?>"><i class="fa-solid fa-trash"></i></a>
                                    <?php endif; ?>
                                </td>
