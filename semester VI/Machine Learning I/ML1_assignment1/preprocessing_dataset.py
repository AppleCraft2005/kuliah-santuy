...
CROP_CONFIGS = {
    ...
    # "Minum": (150, 450, 800),
    "SampaiJumpa": (0, 780, 1000),
    "Haus": (150, 750, 800)
}

def crop_and_resize_by_class(image_path, class_name, target_size=256, to_grayscale=False, flip_horizontal=True):
...
# USAGE
process_folder("dataset/SampaiJumpa", "dataset_preprocessing/SampaiJumpa", "SampaiJumpa")
