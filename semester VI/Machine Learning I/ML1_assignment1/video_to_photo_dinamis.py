...
def video_to_frames_dynamic(video_path, output_folder, label_name, target_fps):
    """
...
input_video = r"D:\SampaiJumpaTerangJauh.mp4" 

# Folder output
output_dir = "dataset/SampaiJumpa"

# Label 
label = "SampaiJumpa"

# Jalankan fungsi dengan menentukan target_fps (misal ingin 5 foto per detik)
video_to_frames_dynamic(input_video, output_dir, label, target_fps=1)